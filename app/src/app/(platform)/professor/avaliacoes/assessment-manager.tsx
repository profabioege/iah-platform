  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
      <header className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div><p className="text-xs font-semibold uppercase tracking-widest text-primary">LessonAssessment</p><h1 className="text-2xl font-semibold">Sondagens diagnósticas</h1><p className="text-sm text-muted-foreground">Autocorreção supervisionada, prazos e devolutiva coletiva.</p></div>
